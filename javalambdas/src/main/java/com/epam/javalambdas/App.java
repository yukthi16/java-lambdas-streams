...
public class App 
{
    public static void main( String[] args )
    {
        ...
        Student student1 = new Student(
            ...
            20,
            new Address("1234"),
            (java.awt.List) Arrays.asList(new MobileNumber("1233"), new MobileNumber("1234")));
 
        Student student2 = new Student(
            "Khyati",
            20,
            new Address("1235"),
            (java.awt.List) Arrays.asList(new MobileNumber("1111"), new MobileNumber("3333"), new MobileNumber("1233")));
 
        Student student3 = new Student(
            "Jason",
            20,
            new Address("1236"),
            (java.awt.List) Arrays.asList(new MobileNumber("3333"), new MobileNumber("4444")));
        ...
        *****************************************************/
        List<Student> stud2 = students.stream()
            .filter(student111 -> ((Collection<MobileNumber>) student111.getMobileNumbers()).stream().anyMatch(x -> Objects.equals(x.getNumber(), "3333")))
        ...
        List<Student> stud3 = students.stream()
            .filter(student -> ((Collection<MobileNumber>) student.getMobileNumbers()).stream().allMatch(x -> Objects.equals(x.getNumber(), "1233") || Objects.equals(x.getNumber(), "1234")))
            .collect(Collectors.toList());
        ...
        *****************************************************/
        TempStudent tmpStud1 = new TempStudent(
            ...
            201,
            new Address("12341"),
            (java.awt.List) Arrays.asList(new MobileNumber("12331"), new MobileNumber("12341")));
 
        TempStudent tmpStud2 = new TempStudent(
            "Khyati1",
            202,
            new Address("12351"),
            (java.awt.List) Arrays.asList(new MobileNumber("11111"), new MobileNumber("33331"), new MobileNumber("12331")));
